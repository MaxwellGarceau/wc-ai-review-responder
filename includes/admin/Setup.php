...
class Setup {
	...
	public function register_scripts() {
		...
		wp_enqueue_script( 'wc-ai-review-responder' );
		wp_enqueue_style( 'wc-ai-review-responder' );
	}
	...
	public function register_page() {
		...
		wc_admin_register_page(
			array(
				'id'     => 'wc_ai_review_responder-example-page',
				'title'  => __( 'Wc Ai Review Responder', 'wc_ai_review_responder' ),
				'parent' => 'woocommerce',
